  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100">
      <div className="space-y-4 w-full max-w-2xl">
        ...
        {/* Create user */}
        <form onSubmit={createUser} className="p-4 bg-blue-100 rounded shadow text-black">
          <input
            placeholder="Name"
            value={newUser.name}
        ...
        {/* Update user */}
        <form onSubmit={handleUpdateUser} className="p-4 bg-green-100 rounded shadow text-black">
          <input
            placeholder="User ID"
            value={updateUser.id}
